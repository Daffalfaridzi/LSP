...
<body class="flex">
    ...
    <div class="flex-1 p-6">
        ...
        <h2 class="text-xl font-semibold text-gray-700 mt-4">Edit Jadwal Penerbangan</h2>
        ...
        <form action="" method="POST" class="mt-6 bg-white p-6 rounded-lg shadow-md">
            ...
            <button type="submit" name="edit" class="w-full py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">Simpan</button>
        </form>
    </div>
</body>
</html>