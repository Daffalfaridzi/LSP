    ...
    <h1 class="text-2xl font-bold text-gray-800 mb-10"><span><a href="index.php">DATA MASKAPAI</a></span> > EDIT MASKAPAI</h1>
        ...
        <h1 class="text-2xl mt-2 font-bold text-gray-800 mb-4 text-center">Tambah Pengguna</h1>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="kapasitas" id="kapasitas" class="form-control w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value="<?= $maskapai["kapasitas"]; ?>" required>
            </div>
