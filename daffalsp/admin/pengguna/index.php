...
if ($keyword) {
    $pengguna = query("SELECT * FROM user WHERE (roles = 'Petugas' OR roles = 'Penumpang') AND (username LIKE '%$keyword%' OR nama_lengkap LIKE '%$keyword%')");
} else {
    $pengguna = query("SELECT * FROM user WHERE roles = 'Petugas' OR roles = 'Penumpang'");
}
