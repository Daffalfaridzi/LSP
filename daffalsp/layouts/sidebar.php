...
<header class="fixed top-0 left-0 right-0 bg-white shadow-md px-6 py-4 flex items-center justify-end z-50">
    <div class="flex items-center space-x-4 mx-3">
        ...
        <span class="font-semibold text-gray-700 text-md mt-1">Hallo Admin, <?= $_SESSION["nama_lengkap"]; ?>👋</span>
    </div>
...
<div class="bg-blue-600 shadow-md fixed top-0 left-0 h-screen w-64 p-4 text-white z-50 flex flex-col justify-between">
    <div>
        ...
        <nav class="font-semibold space-y-2">
            <a href="/daffalsp/admin/dashboard/index.php" class="block py-2 px-4 rounded-xl hover:bg-blue-500 hover:text-white <?php if($page == 'Dashboard') echo 'bg-blue-700 text-white' ?>">
            ...
            <a href="/daffalsp/admin/pengguna/" class="block py-2 px-4 rounded-xl hover:bg-blue-500 hover:text-white <?php if($page == 'Pengguna') echo 'bg-blue-700 text-white' ?>">
                <svg class="w-5 h-5 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="/daffalsp/admin/maskapai/" class="block py-2 px-4 rounded-xl hover:bg-blue-500 hover:text-white <?php if($page == 'Maskapai') echo 'bg-blue-700 text-white' ?>">
                <svg class="w-5 h-5 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10l4 4-4 4M7 6l4 4-4 4m7 0l4 4-4 4"></path>
                </svg>
                Data Maskapai
            </a>
            <a href="/daffalsp/admin/kota/" class="block py-2 px-4 rounded-xl hover:bg-blue-500 hover:text-white <?php if($page == 'Kota') echo 'bg-blue-700 text-white' ?>">
                <svg class="w-5 h-5 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6l8 4 8-4"></path>
                </svg>
                Data Kota
            </a>
            <a href="/daffalsp/admin/rute/" class="block py-2 px-4 rounded-xl hover:bg-blue-500 hover:text-white <?php if($page == 'Rute') echo 'bg-blue-700 text-white' ?>">
                <svg class="w-5 h-5 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 5l7 7-7 7M5 5l7 7-7 7"></path>
                </svg>
                Data Rute
            </a>
            <a href="/daffalsp/admin/jadwal/" class="block py-2 px-4 rounded-xl hover:bg-blue-500 hover:text-white <?php if($page == 'Jadwal') echo 'bg-blue-700 text-white' ?>">
                <svg class="w-5 h-5 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 10l5 5 5-5z"></path>
                </svg>
                Data Jadwal
            </a>
            <a href="/daffalsp/admin/order/" class="block py-2 px-4 rounded-xl hover:bg-blue-500 hover:text-white <?php if($page == 'Tiket') echo 'bg-blue-700 text-white' ?>">
                <svg class="w-5 h-5 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
